	        ...
	        <div id="content-wrap">
	        	...
	        	<div class="page-title"><h1>Gestion de noticias</h1> <span>de la Jornada de Insercion Mechona</span></div>
						...
						while($fila2 = pg_fetch_array($query2)){
							...
							while ($fila3 = pg_fetch_array($query3))
							{
								...
								echo "<tr>
										...
										<td>$nombre_a</td>"
										?>
										<td><input type='submit' value='Editar'"   onclick= "this.form.action ='editarNoticia.php'" ></td>
										<td><input type='submit' value='Eliminar'"  onclick= "this.form.action ='eliminarNoticia.php'" ></td>
										<?php "
					...
					$query5 = pg_query("select * from areas_jim where campus = '$campus' ");
						echo "<form action='agregarNoticia.php' method='post' >
								<table border='1' class='auto-style1'>
								<th>Datos</th>
								<th></th>
								<tr>
