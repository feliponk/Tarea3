					...
					<div id="side-content">
						...
						while ($fila = pg_fetch_array($query))
						{
							...
							while($fila2 = pg_fetch_array($query2))
							{
								...
								?>
												<td><input type='submit' value='Seleccionar'  onclick= "this.form.action ='selecPostulante.php'" ></td>
												<td><input type='submit' value='Descartar'  onclick= "this.form.action ='descartarPostulante.php'" ></td>
								<?php echo "
