	        ...
	        <div id="content-wrap">
	        	...
	        	<div class="page-title"><h1>Eliminar Noticia</h1> <span>de Area de la JIM</span></div>
					...
					<div id="side-content">
						...
						<tr>";
				?>
						<td><input  type='submit' value='Eliminar' onclick= "this.form.action ='eliminarNo.php'" ></td>
						<td><input  type='submit' value='Cancelar' onclick= "this.form.action ='noticias.php'"></td>
						<?php
