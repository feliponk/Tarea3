		...
		<div class="wrapper">
			...
			<div id="nav-bar-holder">
				...
				<ul id="nav" class="sf-menu">
					<li class="current-menu-item"><a href="menuCoor.php">Home</a></li>
					<li><a href="misDatos.php">Mis datos</a></li>
					<li><a href="areas.php">Areas</a></li>
					<li><a>Personal</a>
					<ul>
							<li><a href="coorAreas.php">Coordinadores de Area</a></li>
							<li><a class="current-menu-item" href="postulantes.php">Postulantes</a></li>
	        	...
	        	<div id="page-wrap">
	        		...
	        		<div id="front-slides">
						<div class="slides_container">
							<div class="slide">
								<a href="postulantes.php" target="blank"><img src="img/dummies/01.jpg"  alt="pic" width="940" height="360"  /></a>
								<div class="caption">Revisa las ultimas noticias de tu campus</div>
							</div>
							<div class="slide">
								<a href="noticias.php" target="blank"><img src="img/dummies/02.jpg" alt="pic" width="940" height="360"  /></a>
								<div class="caption">Muchos postulantes esperan tu aprovacion</div>
							</div>
							<div class="slide">
								<img src="areas.php" alt="pic" width="940" height="360"  />
								<div class="caption">Gestiona las areas de la Jim de tu campus</div>
							</div>
						</div>
