	...
	<body>
		...
		<div class="wrapper">
	        ...
	        <div id="content-wrap">
	        	...
	        	<div class="page-title"><h1>Eliminar Noticia</h1> <span>de Area de la JIM</span></div>
					...
					<div id="side-content">
						...
						echo "<h4>Realmente desea eliminar la noticia **$nombre**</h4>";
						...
						<tr>";
				?>
						<td><input  type='submit' value='Eliminar' onclick= "this.form.action ='eliminarNo2.php'" ></td>
						<td><input  type='submit' value='Cancelar' onclick= "this.form.action ='noticias2.php'"></td>
						<?php
