	...
	<body>
		...
		<div class="wrapper">
	        ...
	        <div id="content-wrap">
	        	...
	        	<div class="page-title"><h1>Editar coordinador</h1><span>de areas de la JIM</span></div>
					...
					<div id="side-content">
						...
						echo "<form action='guardareditCA.php' method='post' >
								<table border='1' class='auto-style1'>
								<th>Datos</th>
								<th></th>
								<tr>
									<input name='id_dato' type='hidden' value='$id_dato'>
								...
								<tr>
									<td>Rol: </td>
									<td><input name='f_rol' type='text' value='$rol' ></td>
								</tr>
								<tr>
									<td>Rut: </td>
									<td><input name='f_rut' type='text' value='$rut' ></td>
								</tr>
								<tr>
									<td>Area: </td>
								...
								<tr>
									<td>Telefono: </td>
									<td><input name='f_telefono' type='text' value='$telefono' ></td>
								</tr>
								<tr>
									<td>Talla de polera: </td>
									<td><input name='f_talla' type='text' value='$talla' ></td>
								</tr>
								<tr>
									<td>Carrera: </td>
									<td><input name='f_carrera' type='text' value='$carrera' ></td>
								</tr>
								<tr>
									<td>Correo electronico: </td>
									<td><input name='f_correo' type='text' value='$correo' ></td>
								</tr>
