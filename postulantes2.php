	        ...
	        <div id="content-wrap">
	        	...
	        	<div class="page-title"><h1>Esocojer Postulantes</h1> <span>de la Jornada de Insercion Mechona</span></div>
					...
					<div id="side-content">
						...
						session_start();
						$dato = $_SESSION['idato'];
						$query6 = pg_query("select * from coor_areas where id_dato = $dato");
						...
						while ($fila = pg_fetch_array($query))
						{
							...
							while($fila2 = pg_fetch_array($query2))
							{
								...
								echo "<tr>
									...
									<td>$seleccionado1</td>
									<td>$otra1 / $otra2</td>
									<td>$prioridad1 / $prioridad2</td>
									<td>$seleccionado2 / $seleccionado3</td>"
								?>
												<td><input type='submit' value='Seleccionar'  onclick= "this.form.action ='selecPostulante2.php'" ></td>
												<td><input type='submit' value='Descartar'  onclick= "this.form.action ='descartarPostulante2.php'" ></td>
								<?php echo "
