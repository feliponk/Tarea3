		...
		<div class="wrapper">
			...
			<div id="nav-bar-holder">
				...
				<ul id="nav" class="sf-menu">
					...
					<li><a class="current-menu-item" href="noticias.php">Noticias</a></li>
	        ...
	        <div id="content-wrap">
	        	...
	        	<div class="page-title"><h1>Editar </h1><span>de areas de la JIM</span></div>
					...
					<div id="side-content">
						...
						echo "<form action='guardareditNo.php' method='post' >
								...
								<tr>
									...
									<td>Titular: </td>
									<td><input name='f_titular' type='text' value='$titular' ></td>
								</tr>
								<tr>
									<td>Cuerpo noticia: </td>
									<td><input name='f_cuerpo' type='text' value='$cuerpo' ></td>
								</tr>
									<td>Area: </td>
