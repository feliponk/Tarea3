	...
	<body>
		...
		<div class="wrapper">
	        ...
	        <div id="content-wrap">
	        	...
	        	<div class="page-title"><h1>Escoja Area</h1><span>de la JIM</span></div>
					...
					<div id="side-content">
						...
						$query2 = pg_query("select * from datos where id_dato = $id_dato");
						while ($fila2 = pg_fetch_array($query2))
						{
							$campus = $fila2['campus'];
						}
						$query = pg_query("select * from areas_jim where campus = '$campus'");
						
						
						echo "<form action='seleccionadosArea.php' method='post' >
