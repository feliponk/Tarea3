	...
	<body>
		...
		<div class="wrapper">
	        ...
	        <div id="content-wrap">
	        	...
	        	<div class="page-title"><h1>Eliminar Areas</h1> <span>de la Jornada de Insercion Mechona</span></div>
					...
					<div id="side-content">
						...
						echo "<h4>Realmente desea eliminar el area **$nombre**</h4>";
						...
						<tr>";
				?>
						<td><input  type='submit' value='Eliminar' onclick= "this.form.action ='eliminarA.php'" ></td>
						<td><input  type='submit' value='Cancelar' onclick= "this.form.action ='areas.php'"></td>
						<?php
