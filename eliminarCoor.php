	...
	<body>
		...
		<div class="wrapper">
	        ...
	        <div id="content-wrap">
	        	...
	        	<div class="page-title"><h1>Eliminar Coordinador</h1> <span>de Area de la JIM</span></div>
					...
					<div id="side-content">
						...
						echo "<h4>Realmente desea eliminar el coordinador **$nombre**</h4>";
						...
						<tr>";
				?>
						<td><input  type='submit' value='Eliminar' onclick= "this.form.action ='eliminarC.php'" ></td>
						<td><input  type='submit' value='Cancelar' onclick= "this.form.action ='coorAreas.php'"></td>
						<?php
